...
import './classes/CSteamUser';       // registers getSteamUser on prototype
import './classes/CSteamGroup';      // registers getSteamGroup on prototype
import './classes/CMarketItem';      // registers getMarketItem on prototype
import './classes/CSteamSharedFile'; // registers getSteamSharedFile on prototype
