...
export type HttpCallback = (err: Error | null, response: SteamHttpResponse, body: unknown) => void;
/** Plain string endpoint, or a full options object passed to `_myProfile()`. */
export type MyProfileEndpoint = string | (SteamHttpRequestOptions & {
    endpoint: string;
});
export type PreHttpRequestHook = (requestID: number, source: string, options: SteamHttpRequestOptions, continueRequest: (err: Error | null) => void) => boolean;
...
export declare const PrivacyState: {
    readonly Private: 1;
